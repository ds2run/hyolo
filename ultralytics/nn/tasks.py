...
class DetectionModel(BaseModel):
    ...
    def __init__(self, cfg='yolov8n.yaml', ch=3, nc=None, hier = {}, verbose=True):  # model, input channels, number of classes
        super().__init__()
        ...
        self.hierarchy_names = hier
        self.model, self.save = parse_model(deepcopy(self.yaml), ch=ch, hierarchy_names=self.hierarchy_names, verbose=verbose)  # model, savelist
...
def parse_model(d, ch, hierarchy_names, verbose=True):  # model_dict, input_channels(3)
