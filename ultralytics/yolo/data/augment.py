...
class Mosaic(BaseMixTransform):
    ...
    def _cat_labels(self, mosaic_labels):
        ...
        for labels in mosaic_labels:
            ...
            hierarchy.append(labels['hierarchy_names'])
        ...
        final_labels = {
            ...
            'hierarchy_names': np.concatenate(hierarchy, 0),
...
class RandomPerspective:
    ...
    def __call__(self, labels):
        ...
        img = labels['img']
        cls = labels['cls']
        hierarchy = labels['hierarchy_names']
        ...
        labels['cls'] = cls[i]
        labels['hierarchy_names'] = hierarchy[i]
        labels['img'] = img
...
class Format:
    ...
    def __call__(self, labels):
        ...
        h, w = img.shape[:2]
        cls = labels.pop('cls')
        hierarchy = labels.pop('hierarchy_names')
        instances = labels.pop('instances')
        ...
        labels['hierarchy_names'] = torch.from_numpy(hierarchy) if nl else torch.zeros(nl)
