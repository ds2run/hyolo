...
class TaskAlignedAssigner(nn.Module):
    ...
    def forward(self, pd_scores, pd_bboxes, anc_points, gt_labels, gt_bboxes,
        ...
        pos_align_metrics = align_metric.amax(axis=-1,
    ...
    def get_pos_mask(self, pd_scores, pd_bboxes, gt_labels, gt_bboxes,
                     anc_points, mask_gt):
        # get in_gts mask, (b, max_num_obj, h*w) True where we have positive distance between gt bbox and anchors
    ...
    def get_box_metrics(self, pd_scores, pd_bboxes, gt_labels, gt_bboxes,
        ...
        b = bbox_scores[mask_gt]

        # (b, max_num_obj, 1, 4), (b, 1, h*w, 4)
        pd_boxes = pd_bboxes.unsqueeze(1).repeat(1, self.n_max_boxes, 1,
                                                 1)[mask_gt]
    ...
    def select_topk_candidates(self, metrics, largest=True, topk_mask=None):
        ...
        is_in_topk = torch.zeros(metrics.shape,
                                 dtype=torch.long,
